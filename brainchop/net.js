...
const setupNet = async (device, safetensor) => {
    ...
    return async (_input0) => {
        ...
        addComputePass(device, commandEncoder, pipelines[175], layouts[175], infinityBuf, [output0, buf_0, buf_4, buf_5, buf_31], [32768, 8, 1]);
